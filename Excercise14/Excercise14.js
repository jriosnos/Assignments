...
//     else if (a[1]=='Bella'){bella+=3}
//     else if (a[1]=='Boots'){boots+=3}
//     else if (a[1]=='Lucky'){lucky+=3}
...
var words = ["Totam", "ut", "odit","quis", "Maiores", "unde", "EX", "EST", "corporis"]

words.forEach(a => {
    if (a.length>4 && a == a.toLowerCase()){
